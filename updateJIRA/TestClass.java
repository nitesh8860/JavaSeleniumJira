...
//				HttpURLConnection conn = (HttpURLConnection) url.openConnection(proxy);
		        ...
		        for(int i = 0; i < jsonArry.size(); i++) {
		        	...
		        	System.out.println("Id: " + JSONObject.fromObject(jsonArry.get(i)).get("id"));
		            System.out.println("Status: " + JSONObject.fromObject(jsonArry.get(i)).get("name"));
		            System.out.println("********************************************");
	...
	public static void main(String[] args){
		...
		String testCaseName="TES-2";
		
		testClass.getTransitions(testCaseName);
